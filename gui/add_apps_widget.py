...
class Ui_AddAppsForm(object):
    def setupUi(self, AddAppsForm):
        ...
        self.widget = QtWidgets.QWidget(self.project_frame)
        self.widget.setGeometry(QtCore.QRect(0, 10, 646, 217))
        self.widget.setObjectName("widget")
        self.project_glayout = QtWidgets.QGridLayout(self.widget)
        ...
        self.project_cbox = QtWidgets.QComboBox(self.widget)
        ...
        self.add_project_btn = QtWidgets.QPushButton(self.widget)
        ...
        self.contract_label = QtWidgets.QLabel(self.widget)
        ...
        self.contract_cbox = QtWidgets.QComboBox(self.widget)
        ...
        self.workpack_cbox = QtWidgets.QComboBox(self.widget)
        ...
        self.add_workpack_btn = QtWidgets.QPushButton(self.widget)
        ...
        self.type_cbox = QtWidgets.QComboBox(self.widget)
        ...
        self.service_cbox = QtWidgets.QComboBox(self.widget)
        ...
        self.builder_cbox = QtWidgets.QComboBox(self.widget)
        ...
        self.person_cbox = QtWidgets.QLineEdit(self.widget)
    ...
    def retranslateUi(self, AddAppsForm):
        ...
        self.save_button.setText(_translate("AddAppsForm", "Записать"))
