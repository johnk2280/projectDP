...
# Form implementation generated from reading ui file 'add_apps_widget_v_1_0.ui'
#
...
class Ui_AddAppsForm(object):
    def setupUi(self, AddAppsForm):
        ...
        self.gridLayout_4 = QtWidgets.QGridLayout(self.apps_frame)
        ...
        self.apps_table_widget.horizontalHeader().setDefaultSectionSize(100)
        self.apps_table_widget.horizontalHeader().setMinimumSectionSize(100)
        ...
        self.gridLayout_4.addWidget(self.apps_table_widget, 2, 0, 1, 1)
    ...
    def retranslateUi(self, AddAppsForm):
        ...
        self.org_label.setText(_translate("AddAppsForm", "Застройщик"))
        self.add_org_btn.setText(_translate("AddAppsForm", "Добавить"))
        self.project_label.setText(_translate("AddAppsForm", "Объект строительства"))
