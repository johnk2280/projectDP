...
# Form implementation generated from reading ui file 'services_widget.ui'
#
...
class ServiceForm(object):
    def setupUi(self, ServiceForm):
        ...
        ServiceForm.setMinimumSize(QtCore.QSize(603, 198))
        ServiceForm.setMaximumSize(QtCore.QSize(603, 198))
        self.gridLayout_3 = QtWidgets.QGridLayout(ServiceForm)
        ...
        self.service_ledit = QtWidgets.QLineEdit(self.frame)
        self.service_ledit.setMinimumSize(QtCore.QSize(400, 23))
        self.service_ledit.setMaximumSize(QtCore.QSize(400, 23))
        font = QtGui.QFont()
        ...
        self.mechanism_type_cbox = QtWidgets.QComboBox(self.frame)
        self.mechanism_type_cbox.setMinimumSize(QtCore.QSize(400, 23))
        self.mechanism_type_cbox.setSizeIncrement(QtCore.QSize(400, 23))
        self.mechanism_type_cbox.setEditable(True)
        self.mechanism_type_cbox.setObjectName("mechanism_type_cbox")
        self.gridLayout.addWidget(self.mechanism_type_cbox, 0, 1, 1, 1)
        self.service_label = QtWidgets.QLabel(self.frame)
        self.service_label.setMinimumSize(QtCore.QSize(153, 22))
        self.service_label.setMaximumSize(QtCore.QSize(153, 22))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.service_label.setFont(font)
        self.service_label.setFrameShadow(QtWidgets.QFrame.Plain)
        self.service_label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.service_label.setObjectName("service_label")
        self.gridLayout.addWidget(self.service_label, 1, 0, 1, 1)
    ...
    def retranslateUi(self, ServiceForm):
        ...
        self.cancel_button.setText(_translate("ServiceForm", "Отмена"))
