...
INSERT INTO ogranizations (title, inn, created_at, updated_at)
VALUES 
...
VALUES
	('1/125-2014/НГ', 5, 2, 1, DATE('2014-04-18'), DATETIME('now', 'localtime')),
	('3/127-2015/ЦУП', 1, 1, 5, DATE('2015-01-10'), DATETIME('now', 'localtime')),
	('17/003-2017/ЦУП', 3, 1, 2, DATE('2013-06-11'), DATETIME('now', 'localtime')),
	('125/125-2014/НГ', 7, 2, 8, DATE('2014-07-23'), DATETIME('now', 'localtime')),
	('2/009-2015/ЦУП', 2, 1, 3, DATE('2015-09-01'), DATETIME('now', 'localtime')),
	('17/123-2015/ЦУП', 4, 1, 4, DATE('2015-11-13'), DATETIME('now', 'localtime')),
	('115/008-2020/НГ', 6, 2, 6, DATE('2020-05-03'), DATETIME('now', 'localtime')),
	('25/003-2021/НГ', 8, 2, 7, DATE('2013-06-11'), DATETIME('now', 'localtime')),
	('11/125-2014/ЦУП', 1, 1, 8, DATE('2014-04-28'), DATETIME('now', 'localtime')),
	('30/127-2015/НГ', 5, 2, 2, DATE('2015-10-01'), DATETIME('now', 'localtime')),
	('117/003-2017/НГ', 6, 2, 3, DATE('2013-06-12'), DATETIME('now', 'localtime')),
	('12/125-2014/ЦУП', 2, 1, 4, DATE('2014-08-24'), DATETIME('now', 'localtime')),
	('20/009-2015/НГ', 3, 2, 1, DATE('2015-12-10'), DATETIME('now', 'localtime')),
	('170/123-2015/НГ', 7, 2, 5, DATE('2015-01-13'), DATETIME('now', 'localtime')),
	('11/008-2020/ЦУП', 4, 1, 6, DATE('2020-07-13'), DATETIME('now', 'localtime')),
	('251/003-2021/ЦУП', 8, 1, 7, DATE('2021-06-21'), DATETIME('now', 'localtime'));
